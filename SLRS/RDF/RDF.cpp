...
Forest* __stdcall initRDF(const char* forest_file)
{
	...
	f->initCpp("Class", MEM_DOUBLE, data, 0, "ranger", 9, verbose_out, 0, 8, forest_file, DEFAULT_IMPORTANCE_MODE, DEFAULT_MIN_NODE_SIZE_CLASSIFICATION, "", alwayssplitvars,
...
void __stdcall createForest(const char* input_file)
{
	...
	forest->initCpp("Class", MEM_DOUBLE, input_file, 0, "ranger", 9, verbose_out, 0, 8, "", DEFAULT_IMPORTANCE_MODE, DEFAULT_MIN_NODE_SIZE_CLASSIFICATION, "", alwayssplitvars,
